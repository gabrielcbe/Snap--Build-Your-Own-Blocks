...
SpriteMorph.prototype.initMindMakersBlocks = function() {
    ...
    this.blocks.mBotTurn = {
        ...
        defaults: [['Clockwise'], 125],
    };
    this.blocks.mBotServo = {
    //Unico que não esta funcionando ainda.
        type: 'command',
        category: 'mBot',
...
SpriteMorph.prototype.ArduinoSonar_read = function(trigger_pin, echo_pin) {
    ...
    if (!clienteConectadoArduino) {
        ...
        let sonar_report_pin_arduino = trigger_pin;
...
SpriteMorph.prototype.RpiRemoteIP = function(station) {
    ...
    Http.onreadystatechange = function(e) {
        ...
        else if (station >= 1 && station <= 9) station = '0' + station;
...
SpriteMorph.prototype.RpiSonar_read = function(trigger_pin, echo_pin) {
    ...
    if (!clienteConectadoRaspberryPi) {
        ...
        trigger_pin = parseInt(trigger_pin, 10);
        let sonar_report_pin_rpi = trigger_pin;
...
SpriteMorph.prototype.Monitoronoff = function (sec) {
    ...
    if (now - lastm > 60 * 1000) {  //60 segundos
        lastm = now;
        ...
        console.log('too fast - ',now - lastm);
        let res = {};
        res.message = 'too fast';
        return res;
    }
};